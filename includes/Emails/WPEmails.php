 ...
 * Emails.
 *
 * This class handles all (notification) emails sent by UserFeedback.
 *
...
class WPEmails {
	...
	public function __construct( $template ) {
		...
		add_action( 'insightpulse_email_send_before', array( $this, 'send_before' ) );
		add_action( 'insightpulse_email_send_after', array( $this, 'send_after' ) );
	}
	...
	public function get_from_name() {
		...
		return apply_filters( 'insightpulse_email_from_name', wp_specialchars_decode( $this->from_name ), $this );
	}
	...
	public function get_from_address() {
		...
		return apply_filters( 'insightpulse_email_from_address', $this->from_address, $this );
	}
	...
	public function get_reply_to() {
		...
		return apply_filters( 'insightpulse_email_reply_to', $this->reply_to, $this );
	}
	...
	public function get_cc() {
		...
		return apply_filters( 'insightpulse_email_cc', $this->cc, $this );
	}
	...
	public function get_content_type() {
		...
		if ( ! $this->content_type && $this->html ) {
			$this->content_type = apply_filters( 'insightpulse_email_default_content_type', 'text/html', $this );
		} elseif ( ! $this->html ) {
			$this->content_type = 'text/plain';
		}

		return apply_filters( 'insightpulse_email_content_type', $this->content_type, $this );
	}
	...
	public function get_headers() {
		...
		return apply_filters( 'insightpulse_email_headers', $this->headers, $this );
	}
	 ...
	 * @since 1.0.0
	 */
	public function set_initial_args( $body = array() ) {
		...
		$args = apply_filters( 'insightpulse_emails_templates_set_initial_args', $args, $this );
	...
	public function set_args( $args, $merge = true ) {
		...
		$args = apply_filters( 'insightpulse_emails_templates_set_args', $args, $this );
	...
	public function get_args( $type ) {
		if ( ! empty( $type ) ) {
			return isset( $this->args[ $type ] ) ? apply_filters( 'insightpulse_emails_templates_get_args_' . $type, $this->args[ $type ], $this ) : array();
		}

		return apply_filters( 'insightpulse_emails_templates_get_args', $this->args, $this );
	}
	...
	public function build_email( $message = null ) {
		...
		if ( false === $this->html ) {
			...
			return apply_filters( 'insightpulse_email_message', $message, $this );
		}
		...
		do_action( 'insightpulse_email_body', $email_parts['body'] );
	...
	public function send( $to, $subject, $message = null, $attachments = array() ) {
		...
		do_action( 'insightpulse_email_send_before', $this );
		 ...
		 */
		$data = apply_filters(
			'insightpulse_emails_send_email_data',
			array(
				'to'          => $to,
				'subject'     => $subject,
				'message'     => $message,
		...
		$sent = wp_mail(
			$data['to'],
			wp_specialchars_decode( $this->process_tag( $data['subject'] ) ),
		...
		do_action( 'insightpulse_email_send_after', $this );
	...
	public function process_tag( $string = '', $sanitize = true, $linebreaks = false ) {
		...
		$tag = apply_filters( 'insightpulse_process_smart_tags', $string );
	...
	public function is_email_disabled() {
		return (bool) apply_filters( 'insightpulse_disable_all_emails', false, $this );
	}
	...
	public function get_template() {
		...
		return apply_filters( 'insightpulse_email_template', $this->template );
	}
	...
	public function get_template_part( $slug, $name = null, $load = true ) {
		...
		if ( isset( $name ) ) {
			...
			return apply_filters( 'insightpulse_emails_templates_get_content_part', $html, $template, $this );
		}
	...
	public static function include_html( $template_name, $args = array(), $extract = false ) {
		...
		$located = apply_filters( 'insightpulse_helpers_templates_include_html_located', self::locate_template( $template_name ), $template_name, $args, $extract );
		$args    = apply_filters( 'insightpulse_helpers_templates_include_html_args', $args, $template_name, $extract );
		...
		$extract = apply_filters( 'insightpulse_helpers_templates_include_html_extract_args', $extract, $template_name, $args );
	...
	public static function locate_template( $template_name ) {
		...
		if ( empty( $template_name ) ) {
			return apply_filters( 'insightpulse_helpers_templates_locate', '', $template_name );
		}
		...
		return apply_filters( 'insightpulse_helpers_templates_locate', $located, $template_name );
	}
	...
	public static function get_theme_template_paths() {
		...
		$file_paths = apply_filters( 'insightpulse_email_template_paths', $file_paths );
